...
public final class MapReduceForCustomCodec {
    ...
    public static final MapReduceMessageType TYPE = REQUEST_TYPE;
        ...
        public com.hazelcast.nio.serialization.Data keyValueSource;
 ...
 reducerFactory, com.hazelcast.nio.serialization.Data
 keyValueSource, int
 ...
 chunkSize, java.util.Collection<com.hazelcast.nio.serialization.Data> keys, java.lang.String
 topologyChangedStrategy) {
        final int requiredDataSize = RequestParameters.calculateDataSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, keyValueSource, chunkSize, keys, topologyChangedStrategy);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        com.hazelcast.nio.serialization.Data keyValueSource = null;
        keyValueSource = clientMessage.getData();
            parameters.keyValueSource = keyValueSource;
        int chunkSize ;
