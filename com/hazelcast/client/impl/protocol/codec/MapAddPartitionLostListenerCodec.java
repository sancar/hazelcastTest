...
public final class MapAddPartitionLostListenerCodec {
 ...
 response) {
    ...
    public static ClientMessage encodeMapPartitionLostEvent(int
 ...
 uuid){
    ...
    ;
        ...
        clientMessage.setMessageType(com.hazelcast.client.impl.protocol.EventMessageConst.EVENT_MAPPARTITIONLOST);
  ...
  public static abstract class AbstractEventHandler{
        ...
        public void handle(ClientMessage clientMessage) {
            ...
            if (messageType == com.hazelcast.client.impl.protocol.EventMessageConst.EVENT_MAPPARTITIONLOST) {
        int partitionId ;
