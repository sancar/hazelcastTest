...
public final class MapReduceForListCodec {
 ...
 chunkSize, java.util.Collection<com.hazelcast.nio.serialization.Data> keys, java.lang.String
 topologyChangedStrategy) {
        final int requiredDataSize = RequestParameters.calculateDataSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, listName, chunkSize, keys, topologyChangedStrategy);
    ...
    public static RequestParameters decodeRequest(ClientMessage clientMessage) {
        ...
        java.lang.String listName = null;
        listName = clientMessage.getStringUtf8();
