...
public final class MapReduceForMapCodec {
 ...
 chunkSize, java.util.Collection<com.hazelcast.nio.serialization.Data> keys, java.lang.String
 topologyChangedStrategy) {
        final int requiredDataSize = RequestParameters.calculateDataSize(name, jobId, predicate, mapper, combinerFactory, reducerFactory, mapName, chunkSize, keys, topologyChangedStrategy);
