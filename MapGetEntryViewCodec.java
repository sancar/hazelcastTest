...
public final class MapGetEntryViewCodec {
 ...
 threadId) {
    ...
    public static class ResponseParameters {
        ...
        public static int calculateDataSize(com.hazelcast.map.impl.SimpleEntryView<com.hazelcast.nio.serialization.Data,com.hazelcast.nio.serialization.Data>
 response) {
            int dataSize = ClientMessage.HEADER_SIZE;
            dataSize += Bits.BOOLEAN_SIZE_IN_BYTES;
            if (response != null) {
            dataSize += com.hazelcast.client.impl.protocol.codec.EntryViewCodec.calculateDataSize(response);
            }
            return dataSize;
        }
    }

    public static ClientMessage encodeResponse(com.hazelcast.map.impl.SimpleEntryView<com.hazelcast.nio.serialization.Data,com.hazelcast.nio.serialization.Data>
 response) {
        ...
        if (response == null) {
            ...
            clientMessage.set(response_isNull);
        com.hazelcast.client.impl.protocol.codec.EntryViewCodec.encode(response, clientMessage);
        }
        clientMessage.updateFrameLength();
        return clientMessage;
    ...
    public static ResponseParameters decodeResponse(ClientMessage clientMessage) {
        ...
        com.hazelcast.map.impl.SimpleEntryView<com.hazelcast.nio.serialization.Data,com.hazelcast.nio.serialization.Data> response = null;
        boolean response_isNull = clientMessage.getBoolean();
        if (!response_isNull) {
            response = com.hazelcast.client.impl.protocol.codec.EntryViewCodec.decode(clientMessage);
